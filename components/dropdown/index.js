		...
		<div className='relative inline-block' onBlur={clickOutside}>
			<button
				...
				className={`${btnStyle} ${isOpen ? 'text-fuchsia-800' : ''
					} inline-flex justify-start items-center shadow-none cursor-pointer px-0 py-2 bg-white outline-none active:text-fuchsia-800 focus-visible:text-fuchsia-800 lg:hover:text-fuchsia-800`}>
				{name}
