...
export default function About() {
	return (
		<section className="mt-32">
			<Flex classes="mx-auto my-10 GalaxyFold:p-6">
			...
			<Flex
				...
				reverse={true}>
				<div className="my-20 mx-auto space-y-12">
					<h2 className="text-left">Our Relations</h2>
					...
					<div className="flex flex-row justify-center md:justify-start space-x-7 GalaxyFold:flex-col iPhones:flex-row">
			...
			<div className="my-40">
				<h2 className="text-center mb-10 GalaxyFold:p-6">Support Us Today</h2>
				<div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-10 px-10">
					<Card classes="bg-[#EEBDAD] text-center py-10 space-y-5 mb-12">
					...
					<Card classes="bg-[#EDBBFF] text-center py-10 space-y-5 mb-12">
					...
					<Card classes="bg-[#AAB4D6] text-center py-10 space-y-5 mb-12">
